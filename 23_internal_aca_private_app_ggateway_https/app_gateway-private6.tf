...
resource "azurerm_public_ip" "pip-appgateway6" {
  name                = "pip-appgateway6"
...
resource "azurerm_application_gateway" "appgateway-private6" {
  name                = "appgateway-private6"
  resource_group_name = azurerm_resource_group.rg.name
  location            = azurerm_resource_group.rg.location
  ...
  frontend_ip_configuration {
    ...
    public_ip_address_id = azurerm_public_ip.pip-appgateway6.id
  }
