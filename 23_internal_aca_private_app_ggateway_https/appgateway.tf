locals {
  ...
  appgw_private_ip_address               = "10.0.1.10"
}
...
resource "azurerm_application_gateway" "appgateway" {
  ...
  ssl_certificate {
    ...
    data     = filebase64("/cert/aca-app-01.com.pfx") #File path to the SSL certificate
    password = "1989"
  }
  ...
  frontend_ip_configuration {
    ...
    subnet_id                     = azurerm_subnet.subnet-appgw.id
    private_ip_address            = local.appgw_private_ip_address # "10.0.1.4"
  }
  ...
  #   name                                = local.backend_http_settings_http
  #   port                                = 80
  #   protocol                            = "Http"
  ...
  http_listener {
    ...
    protocol                       = "Http"
    host_name                      = var.custom_domain_name # added
  }
  ...
  http_listener {
    ...
    protocol                       = "Https"
    ssl_certificate_name           = replace(var.custom_domain_name, ".", "-") # var.custom_domain_name
    host_name                      = var.custom_domain_name # added
  }
