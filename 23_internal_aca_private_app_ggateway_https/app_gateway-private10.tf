...
resource "azurerm_public_ip" "pip-appgateway10" {
  name                = "pip-appgateway10"
...
resource "azurerm_application_gateway" "appgateway-private10" {
  name                = "appgateway-private10"
  resource_group_name = azurerm_resource_group.rg.name
  location            = azurerm_resource_group.rg.location
  ...
  frontend_ip_configuration {
    ...
    public_ip_address_id = azurerm_public_ip.pip-appgateway10.id
  }
  ...
  http_listener {
    ...
    frontend_ip_configuration_name = local.frontend_ip_configuration_name # local.frontend_private_ip_configuration_name
